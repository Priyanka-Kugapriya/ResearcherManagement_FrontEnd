...
public class Researcher {
	...
	public String insertUser(String r_name, String r_surname, String r_email, String r_password, String r_productType, String r_registrationDate) 
	 { 
			 String output = ""; 
			 try
			 { 
					 ...
					 String query = " insert into items (`userID`,`name`,`surname`,`email`,`password`,'productType','registrationDate')"
							 		+ " values (?, ?, ?, ?, ?, ?, ?)"; 
					 ...
					 preparedStmt.setString(5, r_password); 
					 preparedStmt.setString(6, r_productType);  
					 preparedStmt.setString(7, r_registrationDate); 
